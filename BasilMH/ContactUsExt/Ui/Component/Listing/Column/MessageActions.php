 ...
 * @version    1.0.0
 */
namespace BasilMH\ContactUsExt\Ui\Component\Listing\Column;
...
{
    const URL_PATH_EDIT   = 'contactusext/index/edit';
    const URL_PATH_DELETE = 'contactusext/index/delete';
                    ...
                    $item[$this->getData('name')] = [
                        ...
                        'delete' => [
                            ...
                            'confirm' => [
                                ...
                                'message' => __('Are you sure you want to delete the Message?')
                            ]
                        ]
                    ];
                }
